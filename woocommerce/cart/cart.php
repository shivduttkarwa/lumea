...
<div class="lumea-cart-page">
	...
	<div class="lumea-cart-empty">
		...
		<!-- Stage: icon / copy left, image right -->
		<div class="lumea-cart-empty-stage">
			...
			<div class="lumea-cart-empty-copy">
				...
				<div class="lumea-cart-empty-actions">
					<a href="<?php echo esc_url( wc_get_page_permalink( 'shop' ) ); ?>" class="lumea-cart-empty-btn-primary"><?php esc_html_e( 'Shop the Collection', 'lumea' ); ?></a>
					<?php
					$bestseller_term = get_term_by( 'name', 'Bestseller', 'product_cat' );
					$bestseller_url  = $bestseller_term ? get_term_link( $bestseller_term ) : wc_get_page_permalink( 'shop' );
					?>
					<a href="<?php echo esc_url( $bestseller_url ); ?>" class="lumea-cart-empty-btn-ghost"><?php esc_html_e( 'Browse Bestsellers', 'lumea' ); ?></a>
				</div>
			</div>

			<div class="lumea-cart-empty-visual" aria-hidden="true">
				<?php
				$empty_img = get_theme_mod( 'lumea_hero_image', LUMEA_THEME_URI . '/assets/images/hero1.jpg' );
				?>
				<img src="<?php echo esc_url( $empty_img ); ?>" alt="" class="lumea-cart-empty-img" loading="lazy">
		...
		<?php
		$lumea_rec_products = wc_get_products( array(
			'status'  => 'publish',
			'limit'   => 4,
			'orderby' => 'popularity',
			'order'   => 'DESC',
		) );
		if ( $lumea_rec_products ) :
		?>
		<div class="lumea-cart-empty-rec">
			<div class="lumea-cart-empty-rec-inner">
				...
				<div class="lumea-cart-empty-rec-grid">
					<?php foreach ( $lumea_rec_products as $lumea_rec_product ) :
...
(function () {
	...
	function bindCartInteractions(cartPage) {
		...
		function replaceWithEmptyState() {
			...
			var heroImg = '<?php echo esc_js( get_theme_mod( 'lumea_hero_image', LUMEA_THEME_URI . '/assets/images/hero1.jpg' ) ); ?>';
			var markup = '' +
				'<div class="lumea-cart-empty">' +
					'<div class="lumea-cart-empty-stage">' +
						'<div class="lumea-cart-empty-copy">' +
							'<div class="lumea-cart-empty-icon" aria-hidden="true">' +
								'<svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.1" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 01-8 0"/></svg>' +
							'</div>' +
							'<p class="lumea-cart-empty-eyebrow"><?php echo esc_js( __( 'Your Bag', 'lumea' ) ); ?></p>' +
							'<h2 class="lumea-cart-empty-title"><?php echo esc_js( __( 'Nothing here yet', 'lumea' ) ); ?></h2>' +
							'<p class="lumea-cart-empty-text"><?php echo esc_js( __( 'Your bag is empty. Browse our botanical skincare collection and find your ritual.', 'lumea' ) ); ?></p>' +
							'<div class="lumea-cart-empty-actions">' +
								'<a href="' + shopUrl + '" class="lumea-cart-empty-btn-primary"><?php echo esc_js( __( 'Shop the Collection', 'lumea' ) ); ?></a>' +
							'</div>' +
						'</div>' +
						'<div class="lumea-cart-empty-visual" aria-hidden="true">' +
							...
							'<div class="lumea-cart-empty-visual-badge">' +
								...
								'<?php echo esc_js( __( 'Free returns on all orders', 'lumea' ) ); ?>' +
							'</div>' +
						'</div>' +
					'</div>' +
				'</div>';
