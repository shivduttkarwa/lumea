...
( function () {
	...
	document.querySelectorAll( '[data-lumea-pw-toggle]' ).forEach( function ( btn ) {
		btn.addEventListener( 'click', function () {
			...
			btn.setAttribute( 'aria-label', isText
				? '<?php echo esc_js( __( 'Show password', 'lumea' ) ); ?>'
				: '<?php echo esc_js( __( 'Hide password', 'lumea' ) ); ?>'
			);
		} );
	} );
	...
	if ( newPwInput && strengthWrap ) {
		...
		var levels = [
			{ score: 0,  cls: '',         text: '' },
			{ score: 1,  cls: 'weak',     text: '<?php echo esc_js( __( 'Weak', 'lumea' ) ); ?>' },
			{ score: 2,  cls: 'fair',     text: '<?php echo esc_js( __( 'Fair', 'lumea' ) ); ?>' },
			{ score: 3,  cls: 'good',     text: '<?php echo esc_js( __( 'Good', 'lumea' ) ); ?>' },
			{ score: 4,  cls: 'strong',   text: '<?php echo esc_js( __( 'Strong', 'lumea' ) ); ?>' },
		];
